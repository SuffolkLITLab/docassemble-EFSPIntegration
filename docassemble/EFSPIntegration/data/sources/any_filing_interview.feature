...
Feature: Make any type of filing
  ...
  Scenario: any_filing_interview can handle a pro-se user
    ...
    And I get to the question id "ready to efile" with this data:
      ...
      | x.filing_description | example description | lead_doc.filing_description |
      | x.exhibits[0].pages | example_upload.pdf | lead_doc.exhibits[0].pages |
      | x.document_type_code | 7688 | lead_doc.document_type_code |
      | x.filing_component_code | 332 | lead_doc.filing_component_code |
      | x[i].pages.there_is_another | False | lead_doc.exhibits[0].pages.there_is_another |
      | x.existing_parties_payment_dict | 3d5553d6-112f-4aec-894f-a5441c1fc304 | lead_doc.existing_parties_payment_dict |
      ...
      | service_contacts.there_is_another | False | |
      | x.filing_action | efile_and_serve | lead_doc.filing_action |
      | x.optional_services.there_are_any | False | lead_doc.optional_services.there_ary_any |
      | al_court_bundle.there_is_another | False | |

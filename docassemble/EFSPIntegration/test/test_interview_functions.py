...
filing_types = [
 ...
 ('143087',
  'Petition Vacate/Modify Final Order-Eviction (w/in 30 days) (no fee)'),
 ('143088',
 ...
 ('143146', 'Certificate'),
 ('143147',
  'Citation/Garnishment/Wage Deduction ($1,000.01 to $5,000.00) (Issued)'),
 ('143148',
  'Citation/Garnishment/Wage Deduction ($5,000.01 or more) (Issued)'),
 ...
 ('181748',
  'Alias Citation/Garnishment/Wage Deduction (up to $1,000.00) (Issued)'),
...
class TestInterviews(unittest.TestCase):
    ...
    def test_exclude(self):
      filters = make_filters(["Appearance"])
      exclude_filter = make_filter(ContainAny(["Limited Scope", "Limited Entry-Local Counsel", "No Fee"]))
